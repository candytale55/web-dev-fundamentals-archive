    ...
    const flagsWithEagles = [Mexico.name, Egypt.name, Ecuador.name];

    const flagsWithFigures = [Gales, Libano, Mexico, NewCaledonia, Uruguay, Argentina, Zambia, Mongolia, Tasmania, Camboya];

    const flagsVShaped = [Vanuatu.name, Guyana.name, EastTimor.name];
    ...
    // Colors, precedence Black, Red, Blue, White, Yellow, Green

    const flagsBlackRedWhite = [Yemen];
