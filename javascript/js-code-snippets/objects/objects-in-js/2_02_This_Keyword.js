...
/*
We have a goat object that can print baaa to the console. 
Everything seems to be working fine. 
If we wanted to add a new method to our goat object called 
.diet() that prints the goat‘s dietType?
*/
...
to the calling object’s properties. In the example above, 
the calling object is goat and by using this we’re accessing the goat object itself, 
