...
/* "anoyingLongFunctionChecksTwoPlusTwoEqualsFourAThousandTimes" is an annoyingly 
long function name that will hurt the readability of the code in which it’s used. 
Let’s pretend we need to keep the name and that the function does important work. 
It needs to be called repeatedly! */
...
let is2p2still4 = anoyingLongFunctionChecksTwoPlusTwoEqualsFourAThousandTimes; 
// Notice we asign it with NO PARENTHESIS at the end. We want to assign the value of the function itself, not the value the function returns when invoked. 
