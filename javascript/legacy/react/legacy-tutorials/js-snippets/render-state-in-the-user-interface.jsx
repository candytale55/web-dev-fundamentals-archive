...
(1) Define an h1 tag in the component's render method which renders the value of name from the component's state.

The h1 should only render the value from state and nothing else. 
