...
/* In the game of golf each hole has a par meaning the average number of strokes a golfer is expected to make in order to sink the ball in a hole to complete the play. Depending on how far above or below par the strokes are, there is a different nickname.

The function golfScore will be passed par and strokes arguments and must return the correct string according to the following list:
