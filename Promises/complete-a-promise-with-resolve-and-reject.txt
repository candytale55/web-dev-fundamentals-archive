...
In promise below, make the promise handle success and failure: 

If responseFromServer is true, call the resolve method to successfully complete the promise. Pass resolve a string with the value "We got the data". 
